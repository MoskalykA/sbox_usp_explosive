namespace Sandbox.MoskalykA {
	[Spawnable]
	[Library( "weapon_usp_explosive", Title = "USP Explosive" )]
	partial class USP_Explosive : Weapon
	{
		...
		public override void AttackPrimary()
		{
			...
			forward += (Vector3.Random + Vector3.Random + Vector3.Random + Vector3.Random) * 0.05f * 0.25f;
